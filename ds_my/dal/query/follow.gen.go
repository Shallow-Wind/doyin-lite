...
func (f followDo) QueryFollowerCount(userID int32) (result int64) {
	...
	generateSQL.WriteString("select count(1) from follow Where user_id = ? and removed = 0 and deleted = 0 ")
...
func (f followDo) QueryFollowCount(funID int32) (result int64) {
	...
	var generateSQL strings.Builder
	params = append(params, funID)
	generateSQL.WriteString("select count(1) from follow Where fun_id = ? and removed = 0 and deleted = 0 ")
